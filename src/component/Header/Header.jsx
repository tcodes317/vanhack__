            ...
            <div className="relative">
                ...
                <div className="xlg:relative">
                    ...
                    <div className="xlg:flex">
                        <div className="xlg:flex xlg:flex-col xlg:justify-between xlg:bg-purple">
                            <h1 className="xlg:text-5xl font-bold xlg:w-8/12">Instantly connect with senior tech talent</h1>
                        ...
                        <div className="xlg:relative">
                            <div className="xlg:w-11/12" id="bx">
                                <div className="xlg:flex xlg:items-center">
                                    ...
                                    <div>
                                        ...
                                        <div className="xlg:text-sm">BackEnd Engineer hired by SkipTheDishes</div>
                                    </div>
                                </div>
                                <div>
                                    <div>
